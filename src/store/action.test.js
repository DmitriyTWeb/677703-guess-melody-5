...
describe(`Action creators work correctly`, () => {
  it(`Acton creator for incrementing step returns correct action`, () => {
  ...
  it(`Action crator for incrementing mistake returns action with 0 payload if answer for artist is correct`, () => {
